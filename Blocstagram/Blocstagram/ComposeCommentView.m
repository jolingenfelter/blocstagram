...
//  Blocstagram
//
//  Created by Joanna Lingenfelter on 5/30/16.
...
- (void) layoutSubviews {
    ...
    if (self.isWritingComment) {
        self.textView.backgroundColor = [UIColor colorWithRed:0.933 green:0.933 blue:0.933 alpha:1.0];
        self.button.backgroundColor = [UIColor colorWithRed:0.345 green:0.318 blue:0.424 alpha:1.0];
        ...
        self.textView.backgroundColor = [UIColor colorWithRed:0.898 green:0.898 blue:0.898 alpha:1.0];
        self.button.backgroundColor = [UIColor colorWithRed:0.6 green:0.6 blue:0.6 alpha:1.0];
...
- (void) setIsWritingComment:(BOOL)isWritingComment animated:(BOOL)animated {
    ...
    if (animated) {
        [UIView animateWithDuration:2.0 delay:0 usingSpringWithDamping:0.25 initialSpringVelocity:0.25 options:kNilOptions animations:^{
